...
Class itmosfera_ubrir extends CModule
{
	const MODULE_ID = 'itmosfera.ubrir';
	var $MODULE_ID = 'itmosfera.ubrir';
	var $MODULE_VERSION;
	...
	function __construct() {
		...
		$this->MODULE_NAME = 'ѕлатежный модуль ”Ѕ–и–';
	...
	function InstallFiles($arParams = array()) {
		...
		if (is_dir($source = $_SERVER['DOCUMENT_ROOT'].'/bitrix/modules/itmosfera.ubrir/install')) {
